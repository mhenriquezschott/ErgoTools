...
class OrganizationWindow(QDialog):
    ...
    def setupUI(self):
        ...
        self.add_child_button = QPushButton("Add element")
        ...
        self.add_child_button.setToolTip("Add a new element at the next hierarchy level beneath the selected location.")
