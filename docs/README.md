# ErgoTools Documentation Index

## Functional Specifications

- [Main assessment UI](main-ui-functional-specification.md): project, worker,
  organization, assessment-context, LiFFT, DUET, Shoulder Tool, result, and body-view
  behavior.
